...
def odom_callback(msg):
    # This function will be called whenever a new Odometry message is received
    # You can process the message data here
    # For example, you can access the position or orientation of the robot

    # Example: Accessing the position
    ...
    z = position.z
    pos = np.array([x, y, z])
    # Example: Accessing the orientation
