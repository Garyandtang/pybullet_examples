...
def MonteCarloSimulation():
    ...
    plt.title('Box Plot of Inertia Matrix Reconstruction Error vs. Dataset Size')
    ...
    plt.title('Box Plot of Mass Reconstruction Error vs. Dataset Size')
    plt.grid(True, linestyle='--', alpha=0.7)
    plt.tight_layout()
    ...
    plt.title('Box Plot of Computation Time vs. Dataset Size (Excluding N=0)')
    plt.grid(True, linestyle='--', alpha=0.7)
    plt.tight_layout()
